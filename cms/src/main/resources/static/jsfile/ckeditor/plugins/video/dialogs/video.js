...
(function(undefined) {
  ...
  var cache = {}, getMetadata = function(dialog, readyCallback) {
    ...
    unbind(video$);
    var url = trim(dialog.getValueOf('info', 'url'));
    if (!url.length) {
      return false;
    }
      ...
      contents: [{
        ...
        elements: [{
          ...
          setup: function(element) {
            ...
            element.$.firstChild.setAttribute('src', trim(this.getValue()));
          },
      ...
      onOk: function() {
        ...
        if (metadata) {
          ...
          realElement.setAttributes({
            ...
            class: 'video-js vjs-fluid placeholder vjs-big-play-centered',
            'data-setup':'{}'
          });
